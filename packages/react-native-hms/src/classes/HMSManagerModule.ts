...
if (HMSManager == null) {
  console.error(
    `[@100mslive/react-native-hmslive] react-native-hms module was not found. Make sure you're running your app on the native platform and your code is linked properly (cd ios && pod install && cd ..).
