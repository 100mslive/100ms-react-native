...
@available(iOS 15.0, *)
class HMSPIPAction: NSObject {

    static let sharedInstance = HMSPIPAction()
    ...
    static func pipAction(_ data: NSDictionary, _ resolve: RCTPromiseResolveBlock?, _ reject: RCTPromiseRejectBlock?) {
//        switch call.method {
//        case "setup_pip":
        setupPIP(data, resolve, reject)
...
//        }
    ...
    static func setupPIP(_ data: NSDictionary, _ resolve: RCTPromiseResolveBlock?, _ reject: RCTPromiseRejectBlock?) {

        guard AVPictureInPictureController.isPictureInPictureSupported() else {
            let errorMessage = "\(#function) PIP is not supported"
...
//        }
        ...
        pipController?.delegate = HMSPIPAction.sharedInstance
...
@available(iOS 15.0, *)
extension HMSPIPAction: AVPictureInPictureControllerDelegate {
