 ...
 */
export const updateNodeWithPeer = (data: { nodes: PeerTrackNode[]; peer: HMSPeer; createNew: boolean }) => {
 ...
 */
export const removeNode = (nodes: PeerTrackNode[], peer: HMSPeer, track: HMSTrack) => {
 ...
 */
export const removeTrackFromNodes = (nodes: PeerTrackNode[], peer: HMSPeer, track: HMSTrack) => {
	const uniqueId = getPeerTrackNodeId(peer, track);
 ...
 * then new `PeerTrackNode` object will be created 
 */
export const updateNode = (data: { nodes: PeerTrackNode[]; peer: HMSPeer; track: HMSTrack; isDegraded?: boolean; createNew: boolean; }) => {
