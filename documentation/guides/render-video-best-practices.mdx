...
The React Native SDK provides a Component HmsView that renders the video on screen. We can pass video trackId, scaleType, mirror and sink in this component.
...
> A Pro tip: Try to render only 2 to 4 videos on a screen and set sink false for other videos
