...
If you need to use a multiple instance approach according to your usage then we recommend you to use the HmsView from the instance as shown above. Do not use the HmsView from the exports of the package, this export will be discarded in the upcoming versions.
